      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-6">
          {products.map((product) => (
            <div
              key={product.id}
              className="flex w-full max-w-sm flex-col rounded-2xl border border-border bg-surface p-6 sm:w-[calc(50%-0.75rem)] lg:w-[calc(33.333%-1rem)]"
            >
              ...
              <button
                ...
                className="mt-6 rounded-full bg-accent px-5 py-2 text-center text-sm font-semibold text-accent-foreground transition-colors hover:bg-accent/90"
              >
                Протестировать демо
              </button>
            </div>
